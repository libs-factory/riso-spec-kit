...
6. **Constitution Validation** (if RisoTech mode enabled):
   ...
   c. Inform user they can run `/speckit.constitution-validation` after specification is complete to perform detailed validation
...
7. Report completion with branch name, spec file path, checklist results, and readiness for the next phase.
   ...
   **Next Steps**:
   ...
   - Run `/speckit.constitution-validation` to validate against project constitution (RisoTech)
